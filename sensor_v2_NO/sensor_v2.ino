 ...
 * 
 * การต่อวงจร ESP-01 (วิธีที่ 2 - ใช้ External Pull-up):
 * - GPIO0: Reed Switch + External Pull-up Resistor 4.7kΩ ไป VCC
 * - GPIO2: LED สถานะ (Optional)
 * - VCC: 3.3V
 * - GND: Ground
 * 
 * วงจร Reed Switch:
 * VCC ---|4.7kΩ|--- GPIO0 ---|Reed Switch|--- GND
 * 
...
// กำหนด PIN - กลับไปใช้ GPIO0 พร้อม External Pull-up
#define REED_SWITCH_PIN 0   // GPIO0 สำหรับ reed switch + External Pull-up 4.7kΩ
...
void setup() {
  ...
  // กำหนด PIN Mode
  pinMode(REED_SWITCH_PIN, INPUT);     // GPIO0 - ไม่ใช้ pull-up ภายใน (มี external แล้ว)
